...
config :fly_code, FlyCodeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "cINbBK+kESFoy9GTexoMQ4dGQhR8WmzUJgrZbQXG6MvvBfXYXYsbS/vGxsC4Xq3j",
  watchers: [
...
config :fly_code, dev_routes: true
...
# Cloak encryption — dev key (generate new for prod via :crypto.strong_rand_bytes(32) |> Base.encode64())

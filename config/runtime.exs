...
#
#     PHX_SERVER=true bin/fly_code start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fly_code, FlyCodeWeb.Endpoint, server: true
end

config :fly_code, FlyCodeWeb.Endpoint,
  http: [port: String.to_integer(System.get_env("PORT", "4000"))]

# FLAME backend selection
flame_backend =
...
config :fly_code, :flame_backend, flame_backend
...
if config_env() == :prod do
  ...
  config :fly_code, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
